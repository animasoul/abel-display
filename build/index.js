...
const AbelDisplaySave = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "shape",
    href: post.link
  }, post.title.rendered))) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, __('No posts found.')));
};
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (wrapper != null) {
      try {
        ...
        let intervalId = setInterval(debounce(changeColorAndShape, 100), 3000);
